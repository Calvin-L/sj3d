...
/**
 * 
 * A collection of settings for render modes and quality. The default settings are as follows:<br>
 * <ul>
...
public final class RenderSettings {
	...
	/**
	 * The maximum shading mode for the renderer. No triangle will be rendered with more complex settings than this.
	 */
	...
	/**
	 * Set the amount of anti-aliasing. Common values are 1 (no anti-aliasing) and 2 (standard anti-aliasing). Intermediate values
	 * may be used for more specific performance-to-speed ratios, larger values can be used for higher quality, and even
	 * smaller values can be used for low-quality rendering. (There is no point to this last one, however, as the overhead
	 * and processing associated with scaling the result will effectively eliminate any speed gains.)
	 * @param factor
	 */
	 ...
	 * @param factor a float value between 0 (for no motion blur) and 0.99 (for full motion blur)
	 */
	 ...
	 * @param mode the shading mode
	 * @param flag true to enable the mode, false to disable it
	 */
	public void setShading(int mode, boolean flag) {
		if (flag) shadeMode |= mode;
		else shadeMode ^= mode;
	}
	 ...
	 * @param flag true to enable shadows, false to disable them
	 */
